...
#[test]
fn lower_invalid_route_repeated_response_status() {
    let text = indoc! {r#"
        route {
            on 404: string
            on 404: i32
...
#[test]
fn lower_invalid_route_non_inline_response_types() {
    let text = indoc! {r#"
        route {
            on 400: enum (string) {
                "A"
...
#[test]
fn lower_invalid_endpoint_response_status_code() {
    let text = indoc! {r#"
        GET {
            name: "foo"
...
#[test]
fn lower_invalid_endpoint_request_body_file_with_json_accept() {
    let text = indoc! {r#"
        GET {
            name: "foo"
...
#[test]
fn lower_invalid_endpoint_repeated_name() {
    let text = indoc! {r#"
        GET {
            name: "foo"
            on 200: string
